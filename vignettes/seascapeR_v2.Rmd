...
```{r}
# bounding box for the Central Peru Ecoregion. You will need to change this bounding box for other ecoregions
lon = -80; lat = -9; w = 8
...
sanctuary = "meow" # or see: ?get_url_ply
dir_data  = here::here("data_ss2")
...
ply <- st_read("data_ss2/ply/meow/meow_ecos.shp") %>% subset(ECOREGION == "Central Peru", geometry) 
```
...
grd <- raster::raster(grds, 1) # 1 is the first raster of the series extracted and you can change the number to see other dates.
